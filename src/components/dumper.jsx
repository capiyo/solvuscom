   ...
   // let myId=id.toString()
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/jobs/current-job/${id}`).then(res => res.json()).then(
...
const addToats=()=>{
    ...
    return (
        <div className='max-w-scren-2xl  w-full md:w-5/6 lg:w-6/8 container mt-2 mx-auto xl:px-24 px-4 '>
            ...
            <div className='  bg-gradient-to-r from-purple-300 to-green-600 mx-auto py-12 md:px-14 px-8 rounded-lg'>
                        ...
                        <div className='w-full'>
                            ...
                            <div className='flex items-center flex-wrap justify-center md:justify-normal'>
                                ...
                                <div className='mx-4 my-3 text-center md:text-left md:my-0'>
                                    ...
                                    <p className='text-secondary'>Umpire.com</p>
                ...
                <form className='mt-8' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='px-2 grid grid-cols-1 md:grid-cols-2 items-center justify-items-center gap-4'>
                        ...
                        <div className='w-full md:w-5/6'>
                            ...
                            <input type="file" onChange={handleFileUpload} {...register("resume")} 
                            id="file-input" class="block w-full cursor-pointer border border-primary shadow-sm rounded-lg text-sm focus:z-10
                             focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none file:bg-primary file:text-white file:border-0 file:me-4 file:py-2 file:px-3" />
                        </div>
                            ...
                            job && applicants &&
                                ...
                                <Link to={`/application-form/${job._id}`}>
                                    <div className='flex justify-center'>
                                        <button className='block    bg-gradient-to-r from-purple-600 to-red-600  text-white text-md py-2 px-12 md:px-16 rounded-md'>
